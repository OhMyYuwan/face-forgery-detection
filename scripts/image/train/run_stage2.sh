...
STAGE1_MODEL="your_pretrained_stage1_model" # /zyy/models/MambaVision/gpu3/stage1_models_nvidia/MambaVision-T-1K/ckpt_epoch_50.pth
# ===========================================
...
for i in "${!GPU_IDS[@]}"; do
    echo "  - GPU ${GPU_IDS[$i]}: tail -f log/xinyuan_MambaVision_gpu${GPU_IDS[$i]}_stage2.log"
done
echo ""
echo "Monitor all logs:"
echo "  tail -f log/xinyuan_MambaVision_gpu_stage2*.log"
echo ""
...
echo "  - Stage 1 models: ${SAVE_PATH}/stage2*/stage1_models_${BACKBONE}/"
echo "  - Stage 2 models: ${SAVE_PATH}/stage2*/stage2_detnet_enhance/path_models_${BACKBONE}/"
