...
scan_models() {
    ...
    # A valid model dir must contain both model.py and pytorch_model.bin (or .pth symlink)
    AVAILABLE_MODELS=()
    for dir in "$WEIGHTS_DIR"/*/; do
        [ ! -d "$dir" ] && continue
        model_name=$(basename "$dir")

        # Skip hidden directories and non-model directories
        [[ "$model_name" == .* ]] && continue
...
start_service() {
    ...
    # Check dependencies
    print_info "检查依赖..."
    if ! pip list | grep -E "gradio|torch|timm|huggingface-hub" > /dev/null; then
    ...
    if is_running; then
        ...
        print_info "使用 './space_manager.sh status' 查看状态"
        print_info "使用 './space_manager.sh stop' 停止服务"
        return 0
    else
...
用法:
  ./space_manager.sh {start|stop|restart|status|help}
...
示例:
  ./space_manager.sh start    # 启动服务
  ./space_manager.sh status   # 查看状态
  ./space_manager.sh stop     # 停止服务

EOF
}

# Show overview (models + help)
show_overview() {
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "  ${APP_NAME}"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
